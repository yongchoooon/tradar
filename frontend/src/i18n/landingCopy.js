export const landingCopy = {
  en: {
    ...
    simulation: {
      ...
      rerunNotice: '❗ To re-simulate, change the name, image, or goods/services and run it again below.',
      buttons: {
        run: 'Run Simulation',
        rerun: 'Re-simulation',
        cancel: 'Cancel',
  ...
  ko: {
    ...
    simulation: {
      ...
      rerunNotice: '❗ 재시뮬레이션을 하려면 상표명, 이미지, 상품/서비스류를 바꾸고 아래에서 다시 실행하세요.',
      buttons: {
        run: '시뮬레이션 시작',
        rerun: '재시뮬레이션',
        cancel: '실행 취소',
